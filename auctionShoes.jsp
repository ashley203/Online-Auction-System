...
<%
	...
	try {
		...
		String insert = "INSERT INTO clothing(style, brand, clothing_type, color, manufacture_date)"
				+ "VALUES (?, ?, ?, ?, ?)";
		String insert2 = "INSERT INTO shoes(clothing_id, shoe_size, width, material)"
				+ "VALUES (?, ?, ?, ?)";
		...
		if (style.equals("")){
			...
			ps.setString(3, "shoes");
			ps.setString(4, color);
			ps.setString(5, manufactureDate);
				
			ps2.setString(2, shoeSize);
			ps2.setString(3, width);
			ps2.setString(4, material);		
