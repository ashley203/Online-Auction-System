...
<html>
	<head>
		...
		<title>Create Pants Auction</title>
	</head>
	<body>
<%
	String error = "";
	try {
		...
		String pantsSize = request.getParameter("pantsSize");
		...
		String insert = "INSERT INTO clothing(style, brand, clothing_type, color, manufacture_date)"
				+ "VALUES (?, ?, ?, ?, ?)";
		String insert2 = "INSERT INTO pants(clothing_id, pants_size, pants_fit)"
				+ "VALUES (?, ?, ?)";
		...
		else if (pantsSize.equals("")){
			error = "Input a pants size";
